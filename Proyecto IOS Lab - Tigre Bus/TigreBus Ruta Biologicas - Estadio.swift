//
//  TigreBus Ruta Biologicas - Estadio.swift
...
class TigreBus_Ruta_Biologicas___Estadio: UIViewController {
    ...
    @IBOutlet weak var botonParada7: UIButton!
    ...
    override func viewDidLoad() {
        ...
        botonParada7.backgroundColor = UIColor.red
        ...
        ref.observe(.value, with: {(snapshot) in
            if let diccionario = snapshot.value as? [String: Any]{
                ...
                let firebaseRuta7 = diccionario["Parada 7"] as! Bool
                ...
                if self.ruta7 == true{
                    self.botonParada7.backgroundColor = UIColor.green
                }else{
                    if (self.contadorParada+1) == 7 {
                        self.botonParada7.backgroundColor = UIColor(red: 234/255.0, green: 226/255.0, blue: 2/255.0, alpha: 1)
                    }else{
                        self.botonParada7.backgroundColor = UIColor.red
                    }
                }
            }
    ...
    @IBAction func mensajeParada7(_ sender: UIButton) {
        if self.ruta7 == true{
            alerta()
        }else{
            if (contadorParada+1) == 7{
                alerta2()
            }else{
                alerta3()
            }
